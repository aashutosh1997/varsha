...
// MARK: - Exercise Library (shared across plans)

let sharedExerciseLibrary = ExerciseLibrary(exercises: Dictionary(uniqueKeysWithValues: [
    Exercise(
